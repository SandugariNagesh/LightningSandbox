          ...
          /*  else if(c.Case_Record_Type__c == 'Zoning Residential')  {
            ...
            // Workflow Implementation for Abandoned Bike.
             ...
             // Workflow Implementation for Smoke Detector.
                ...
                if(c.Owner_Occupied_Property__c == 'No')  {
                    c.Service_Request_Type__c = 'Service Not Needed';
                    c.Status = 'Closed';
                    c.Reason = 'Service Not Needed';
                }
            ...
            // Workflow Implementation for Street Paving.
                ...
                if(c.Request_for_New_Stop_Sign__c=='Yes')  {
                    c.Service_Request_Type__c = 'Service Not Needed';
                    c.Status = 'Closed';
                    c.Reason = 'Service Not Needed';                    
                }
       ...
       */
            ...
            if (!CaseFieldUpdate.inFutureContext) {
                ...
                for (Case c : Trigger.new) {
                    ...
                    //Changed the Owenername condition to "311 Contact Center" from "311 Mobile Requests" as per ticket#11908406
                    if(ownerName != null && ownerName == '311 Contact Center' && c.Validated_Cases_from_PS__c == FALSE)
                        CaseId.add(c.id); 
                        ...
                        //Replaced the 'CitiWorks Reject' with "311 Mobile and Web Address Review"
                        else if(ownerName != null && ownerName == '311 Mobile and Web Address Review' && c.Centerline_2272x__c != null && c.Centerline_2272x__c != 0 && c.Centerline_2272x__c != 0.0)
                            CaseId.add(c.id);
                    }
                    else if(c.Validated_Cases_from_PS__c != TRUE) {        
                        if(ownerName != null && ownerName == '311 Mobile and Web Address Review' && c.Centerline_2272x__c != null && c.Centerline_2272x__c != 0 && c.Centerline_2272x__c != 0.0)
                            CaseId.add(c.id);  
